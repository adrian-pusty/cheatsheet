...
ffmpeg -i input_file.mp3 -f segment -segment_time 900 -c copy %03doutput_file.mp3       # split into 15 minute files ~https://unix.stackexchange.com/a/283547/447876
...
amixer set Master 50% # set volume to 50%

for file in ./*.mp3; do
#  id3v2 -g "Audiobook" "$file"; # genre
  id3v2 -A "Album Title" "$file";
done

# cleanup # clean up
sudo apt-get clean
sudo du -ah --max-depth=100 --exclude=/media / | sort -hr | head -n 20
docker system prune